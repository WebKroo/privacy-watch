...
1. Download **[Privacy-Watch-1.6.1.dmg](https://github.com/WebKroo/privacy-watch/releases/download/v1.6.1/Privacy-Watch-1.6.1.dmg)** from the official GitHub release. The neighboring `.dmg.sha256` file lets you verify its checksum.
...
The DMG includes the same app as the 1.6.1 ZIP, an Applications shortcut, a **Read Me First** guide and a **Documentation** folder with the AGPLv3 license and source links. It remains a free, locally signed, unnotarized release; a DMG does not remove Gatekeeper warnings.
